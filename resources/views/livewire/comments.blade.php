                    ...
                    @if(auth()->id() === $comment->user_id)
                        <div class="flex space-x-2">
                            ...
                            <button 
                                ...
                                class="text-gray-400 hover:text-danger-500 dark:hover:text-danger-400" onclick="confirm('Confirm Delete Categoria id {{$comment->id}}? \nDeleted Categorias cannot be recovered!')||event.stopImmediatePropagation()">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
